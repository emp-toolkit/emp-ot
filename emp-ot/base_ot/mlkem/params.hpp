#ifndef EMP_OT_MLKEM_PARAMS_HPP__
#define EMP_OT_MLKEM_PARAMS_HPP__

// Internal header — only included by emp-ot/base_ot/mlkem/*.cpp / *.hpp.
...
//
// NOTE: this header MUST NOT be transitively included from a public
// base-OT header (e.g. emp-ot/base_ot/bmm.h), because that would leak the
// KYBER_K macro into every emp-ot consumer. Keep Kyber linkage entirely
// behind the bmm.cpp boundary.

#define KYBER_K 2

extern "C" {
#include "emp-ot/base_ot/mlkem/kyber/params.h"
#include "emp-ot/base_ot/mlkem/kyber/poly.h"
#include "emp-ot/base_ot/mlkem/kyber/polyvec.h"
#include "emp-ot/base_ot/mlkem/kyber/cbd.h"
#include "emp-ot/base_ot/mlkem/symmetric.h"  /* keccak_state, prf, kyber_shake128_*, etc. */
}
...
#endif  // EMP_OT_MLKEM_PARAMS_HPP__
